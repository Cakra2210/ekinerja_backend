...
import { EvaluationRow } from "./berakhlak.types";

export const BASE_SELECT = `SELECT ev.id,
...
export const mapEvaluationRows = (rows: Array<Record<string, unknown>>): EvaluationRow[] =>
  rows.map((row) => ({
    id: num(row.id),
