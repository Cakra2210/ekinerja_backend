...
const TOTAL_WEIGHT = PERFORMANCE_WEIGHT + BERAKHLAK_WEIGHT + ATTENDANCE_WEIGHT + COMPETENCY_WEIGHT;
const readPositiveNumber = (value) => {
    const parsed = Number(value);
    return Number.isFinite(parsed) && parsed > 0 ? parsed : 0;
};
exports.getRankings = (0, http_1.asyncHandler)(async (req, res) => {
    ...
    const berakhlakConditions = [];
    const berakhlakParams = [];
    if (year > 0) {
